...
sub Zvlsseg_insert {
        ...
        if (($nf > 1) & ($str_op_src =~ /(v[ls][suo]?x?)(ei?\d+(ff)?)\.v/)) {
                my $vls = $1;
                my $edff = $2;
                $str_op = $1."seg$nf".$2.".v";
        } else {
...
sub op_imm {
	...
	case 1 {
		switch($subop7) {
		case 20 {
			if ($misa_base != 2) { $str_op = "bseti"; $shift = 1 }
			# else { return unknown(); }
		}
		case 36 {
			if ($misa_base != 2) { $str_op = "bclri"; $shift = 1 }
			# else { return unknown(); }
		}
		case 48 {
			switch($shamt) {
			...
			case 1 {$str_op = "ctz"}
			case 2 {$str_op = "cpop"}
			case 4 {$str_op = "sext.b"}			
			case 5 {$str_op = "sext.h"}			
			}
			return sprintf "%s %s, %s", $str_op, str_ireg($rd), str_ireg($rs1);
		}
		case 52 {
			if ($misa_base != 2) { $str_op = "binvi"; $shift = 1 }
			# else { return unknown(); }
		}		
		# else    { return unknown(); }
		}
...
sub op_imm_32 {
	...
	case 1 {
		switch($subop6) {
		case 2  { $str_op = "slli.uw" ; $shamt = ($instn >> 20) & 0x3f; $shift = 1; }
		}
		switch($subop7) {
		case 0 { $str_op = "slliw" ; $shift = 1;}
		case 48 { 
			switch($shamt) {
			case 0 { $str_op = "clzw" }
			case 1 { $str_op = "ctzw" }
...
sub op {
	...
	case 2 {
		...
		case 5 { $str_op = "clmulr" }
		case 16 { $str_op = "sh1add" }
		else { return unknown();}
		}
	}
	case 3 {
	...
	case 4 {
		...
		case 0 { $str_op = "xor" }
		case 1 { $str_op = "div" }
		case 4 { $str_op = "zext.h"; return sprintf "%s %s, %s", $str_op, str_ireg($rd), str_ireg($rs1);}
		case 5 { $str_op = "min" }
		case 16 { $str_op = "sh2add" }
		case 32 { $str_op = "xnor" }		
		else { return unknown();}
		}
	}
...
sub op_fp {
	...
	case  8 {
		switch($rs2) {
			...
			case 6	{$str_op = "fcvt.s.bf16"}
			case 8	{$str_op = "fcvt.bf16.s"}            
			else	{ return unknown();  }
		}
	        $frs2_disable = 1;
                $instr_with_rm = 1;
...
sub op_v {
        ...
        case 1 {
                switch($func3) {
                case 1 { $str_op = "vfredusum.vs"; $inst_rd = DST_VD; $inst_src = SRC_VS1; $inst_src2 = SRC_VS2; }
        ...
        case 10 { 
                ...
                case 6 { $str_op = "vasubu.vx";  $inst_rd = DST_VD; $inst_src = SRC_XS1; $inst_src2 = SRC_VS2; }
                else   { return unknown();}
                }
        }
        case 11 { 
        ...
        case 14 {
                ...
                case 5 { $str_op = "vfslide1up.vf";   $inst_rd = DST_VD; $inst_src = SRC_FS1; $inst_src2 = SRC_VS2; }
        ...
        case 15 {
                ...
                case 5 { $str_op = "vfslide1down.vf"; $inst_rd = DST_VD; $inst_src = SRC_FS1; $inst_src2 = SRC_VS2; }
        ...
        case 16 {
                if ($func3 == 2) {
                        ...
                        case 16 { $str_op = "vcpop.m";  $inst_rd = DST_XD; $inst_src = SRC_VS2; }
        ...
        case 18 { 
			...
			case 1 {
				...
				case 13 { $str_op = "vfwcvtbf16.f.f.v"}
				...
				case 29 { $str_op = "vfncvtbf16.f.f.w"}
				else    { return unknown();}
				}
				$inst_rd = DST_VD;
				$inst_src = SRC_VS2;
        ...
        case 24 { 
                ...
                case 2 { $str_op = "vmandn.mm";   $inst_rd = DST_VD; $inst_src = SRC_VS1; $inst_src2 = SRC_VS2; }
        ...
        case 28 { 
                ...
                case 2 { $str_op = "vmorn.mm";   $inst_rd = DST_VD; $inst_src = SRC_VS1; $inst_src2 = SRC_VS2; }
        ...
        case 49 {
                ...
                case 1 { $str_op = "vfwredusum.vs";$inst_rd = DST_VD; $inst_src = SRC_VS1; $inst_src2 = SRC_VS2; }
        ...
        case 59 {
                switch($func3) {
                case 1 { $str_op = "vfwmaccbf16.v.v"; $inst_rd = DST_VD; $inst_src = SRC_VS1; $inst_src2 = SRC_VS2; }
                case 2 { $str_op = "vwmul.vv"; $inst_rd = DST_VD; $inst_src = SRC_VS1; $inst_src2 = SRC_VS2; }
                case 5 { $str_op = "vfwmaccbf16.v.f"; $inst_rd = DST_VD; $inst_src = SRC_VS2; $inst_src2 = SRC_FS1; }
...
sub custom2{
	...
	case 4 { 
		if (($func7 >> 1) == 0) {
			switch($rs1) {
				case 0 {
					$str_op = "vfwcvt.s.bf16_v5";
					$flag = 4;
				}
				case 1 {
					$str_op = "vfncvt.bf16.s_v5";
					$flag = 4;
				}
				case 2 {
					$str_op = "fcvt.s.bf16_v5";
					$flag = 5;
				} 
				case 3 {
					$str_op = "fcvt.bf16.s_v5";
					$flag = 5;
				}
				case 4 {
					$str_op = "vfwcvt.f.n.v";
	...
	if ($flag == 1) {
		...
		return sprintf "%s %s, %s, %s", $str_op, str_ireg($rs1), str_imm7($imm1), str_pc_offset11($imm2);
	}
	elsif ($flag == 3) {
		$imm1 = ($misa_base == 2) ? (($instn >> 20) & 0x1f) + (($instn >> 2) & 0x20): (($instn >> 20) & 0x1f);
		$imm2 = (($instn >> 21) & 0x400) + (($instn >> 20) & 0x3e0) + (($instn >> 7) & 0x1e);
		return sprintf "%s %s, %s, %s", $str_op, str_ireg($rs1),($misa_base == 2) ? str_imm6($imm1) : str_imm5($imm1), str_pc_offset11($imm2);
	}
	elsif ($flag == 4) {
...
sub sys {
	...
	case 0x7f0  { $csr_name = "mppib"; }
	case 0x7f1  { $csr_name = "mfiob"; }
	...
	case 0xfc4  { $csr_name = "mmsc_cfg3"; }
	case 0xfc7  { $csr_name = "mvec_cfg"; }
	case 0xfca  { $csr_name = "mrvarch_cfg"; }
	case 0xfcb  { $csr_name = "mrvarch_cfg2"; }
	case 0xfcf  { $csr_name = "ml2c_ctl_base"; }
	case 0xfd0  { $csr_name = "mhvm_cfg"; }
	case 0xfd1  { $csr_name = "mhvmb"; }
	else      { $csr_name = $csr; }
	}
	switch($func3) {
	case 0 {
